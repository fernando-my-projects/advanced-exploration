package org.academiadecodigo.advancedexploration.pictures;

import org.academiadecodigo.advancedexploration.graphics.Canvas;
import org.academiadecodigo.advancedexploration.graphics.Color;
import org.academiadecodigo.advancedexploration.graphics.Movable;
import org.academiadecodigo.advancedexploration.graphics.Shape;
...
public class Picture implements Shape, Movable {
     ...
     */
    public org.academiadecodigo.advancedexploration.graphics.Color getColorAt(int i) {
     ...
     */
    public void setColorAt(int i, org.academiadecodigo.advancedexploration.graphics.Color color) {
        if (image == null || i < 0 || i >= pixels()) {
            throw new IndexOutOfBoundsException("" + i);
        } else {
     ...
     */
    public org.academiadecodigo.advancedexploration.graphics.Color getColorAt(int x, int y) {
        if (image == null || x < 0 || x >= image.getWidth() || y < 0 || y >= image.getHeight()) {
            throw new IndexOutOfBoundsException("(" + x + "," + y + ")");
        } else {
            int rgb = image.getRGB(x, y) & 0xFFFFFF;
            return new org.academiadecodigo.advancedexploration.graphics.Color(rgb / 65536, (rgb / 256) % 256, rgb % 256);
        }
    }
    ...
    public void setColorAt(int x, int y, Color color) {
        if (image == null || x < 0 || x >= image.getWidth() || y < 0 || y >= image.getHeight()) {
            ...
            org.academiadecodigo.advancedexploration.graphics.Canvas.getInstance().repaint();
        }
    }
     ...
     */
    public void draw() {
        org.academiadecodigo.advancedexploration.graphics.Canvas.getInstance().show(this);
    }
     ...
     */
    public void delete() {
        org.academiadecodigo.advancedexploration.graphics.Canvas.getInstance().hide(this);
    }
